...
const ALL_TABS = [
  ...
  { id: 'config-team-dashboard', label: 'Painel Eq. Config.', icon: Settings2, minRole: 'gerente' },
  ...
  { id: 'config-comparative', label: 'Comp. Eq. Config.', icon: GitCompareArrows, minRole: 'gerente' },
