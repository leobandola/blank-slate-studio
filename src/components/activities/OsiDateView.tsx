...
export function OsiDateView({ activities, onFilter }: OsiDateViewProps) {
  ...
  const groupedActivities = useMemo(() => {
    const groups: Record<string, OsiActivity[]> = {};
    ...
    const sortedGroups: Record<string, OsiActivity[]> = {};
    ...
    <Card className="mb-6">
      ...
      <CardContent>
        ...
        <div className="text-sm text-muted-foreground mb-4">
          ...
          <br />
          <strong>Total de atividades OSI:</strong> {getFilteredActivities.length}
        </div>

        {Object.keys(groupedActivities).length > 0 && (
          <div className="mt-4">
            <h4 className="font-medium mb-2">Atividades OSI por Data:</h4>
